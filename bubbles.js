(function () {
  ...
  d3.csv("infoviz.csv", function(datapoints){ 
    ...
    var get_building_id = function(d) {
      id_list = ["1bbf041c-f23c-437e-9c9b-2bd43d310a7c", "52b41c98-ab21-4ad5-828b-74069bcd55e7", "c8f283c8-4e1f-4e59-8364-6e8bd70a2c24"];
    ...
    var circles = svg.selectAll(".apartment_id")
      ...
      .attr("fill", function(d){
        hot_percentage=d.value.hot/d.value.volume*100;
        cold_percentage=d.value.cold/d.value.volume*100;
        // Konstig data eller fel i rollup?
        // console.log(d.value.hot)
        // console.log(d.value.cold)
        // console.log(hot_percentage);
        // console.log(cold_percentage);
        grad = svg.append("defs").append("linearGradient").attr("id", "grad"+d.key)
